...
self.addEventListener('fetch', e => {
  ...
  // Network-first for the app shell: always try the network so code changes
  // reach the browser immediately, refresh the cache, and fall back to the
  // cache only when offline. (The old cache-first design served stale app.js
